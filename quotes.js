const quotes = [
  ...
  {
    author: "Epictetus",
    text: `Who is your master? Anyone who has control over things upon which you’ve set your heart, or over things which you seek to avoid.`
  },
  ...
  {
    author: "Epictetus",
    text: `We are not privy to the stories behind people’s actions, so we should be patient with others and suspend judgement of them, recognizing the limits of our understanding.`
  },

  {
    author: "Epictetus",
    text: `Deliberate much before saying or doing anything, for you will not have the power of recalling what is said or done.`
  },

  {
    author: "Epictetus",
    text: `It isn’t the events themselves that disturb people, but only their judgements about them.`
  },
  ...
  {
    author: "Epictetus",
    text: `To make the best of what is in our power, and take the rest as it occurs.`
  },
  ...
  { author: "Epictetus", text: `Don't explain your philosophy. Embody it.` },
  ...
  {
    author: "Epictetus",
    text: `Don't just say you have read books. Show that through them you have learned to think better, to be a more discriminating and reflective person.`
  },
  ...
  { author: "Epictetus", text: `You become what you give your attention to.` },
  ...
  {
    author: "Epictetus",
    text: `Personal merit cannot be derived from an external source. It is not to be found in your personal associations, nor can it be found in the regard of other people. It is a fact of life that other people, even people who love you, will not necessarily agree with your ideas, understand you, or share your enthusiasms.`
  },
  ...
  {
    author: "Epictetus",
    text: `Never depend on the admiration of others. There is no strength in it. `
  },
  ...
  { author: "Seneca", text: "All cruelty springs from weakness." },
  ...
  { author: "Seneca", text: "As long as you live, keep learning how to live." },

  { author: "Seneca", text: "The sun also shines on the wicked." },
  ...
  { author: "Seneca", text: "To wish to be well is a part of becoming well." },

  { author: "Seneca", text: "There is no genius without a touch of madness." },

  { author: "Seneca", text: "While we wait for life, life passes." },
  ...
  { author: "Marcus Aurelius", text: "What we do now echoes in eternity." },
